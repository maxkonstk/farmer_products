...
@section('title', 'Локальные фермерские продукты с доставкой по Ижевску')
    ...
    <section class="hero-section hero-section--commerce">
        <div class="site-container hero-grid hero-grid--commerce">
            <div class="hero-copy">
                ...
                <h1 class="hero-title">Фермерские продукты с понятным происхождением и спокойной доставкой по Ижевску</h1>
