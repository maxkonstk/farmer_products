...
@section('meta_description', 'Кто стоит за проектом «Фермерская лавка»: локальные хозяйства, короткая цепочка поставки и принципы работы с сезонными продуктами в Самаре.')
        ...
        <div class="site-container article-layout">
            <div class="page-intro">
                <div>
                    ...
                    <p class="page-subtitle">Мы собираем сезонные продукты у небольших хозяйств, привозим их в Самару без длинного складского плеча и сохраняем живой контакт с покупателем на каждом заказе.</p>
                </div>
            </div>
